...
##       (cur_tableau_add_mesh, ":banner_mesh", pos1, ":banner_scale", 0),
  ...
  ("faction_note_mesh_for_menu", 0, "gekokujo_pic_arms_uesugi", 1024, 512, 0, 0, 450, 225,
   [
     ...
     (try_begin),
       ...
       (store_add, ":banner_mesh", "mesh_gekokujo_pic_arms_uesugi", ":faction_no"),
  ...
  ("faction_note_mesh", 0, "gekokujo_pic_arms_uesugi", 1024, 512, 0, 0, 500, 250,
   [
     (store_script_param, ":faction_no", 1),
     (cur_tableau_set_background_color, 0xFFFFFFFF),
     (set_fixed_point_multiplier, 100),
...
#Gekokujo Start
  ...
  #gekokujo 3.0 sashimono tableaus start
  ("gekokujo_sashimono", 0, "sample_gekokujo_sashimono_heraldic", 1024, 1024, 0, 0, 0, 0,
   [
       ...
       (position_set_z, pos1, 10),
       (position_set_x, pos1, -86),#-87 #-85
       (position_set_y, pos1, -30),#30#-20 #-22
       (cur_tableau_add_mesh, ":banner_mesh", pos1, 37, 0), #43
       (init_position, pos1),
       (position_set_z, pos1, 100),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_gekokujo_sashimono", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
