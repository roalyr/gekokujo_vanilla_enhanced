...
skills = [
  ...
  #gekokujo 3.0 foraging -- instead of removing the effects of shields, just hide them and pretend...
  #("shield","Shield",sf_base_att_agi,0,"Reduces damage to shields (by 8%% per skill level) and improves shield speed and coverage. (Personal skill)"),
  ("shield","Foraging",sf_base_att_agi,10,"Allows the party to forage for 5 food per skill level (camp, siege, raiding) and increase foraging range (Party skill)"),
